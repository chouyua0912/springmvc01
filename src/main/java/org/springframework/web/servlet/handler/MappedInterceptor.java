...
/**
 * Contains and delegates calls to a {@link HandlerInterceptor} along with                  封装、代理HandlerInterceptor操作
 * include (and optionally exclude) path patterns to which the interceptor should apply.    在XML配置里面定义了mvc:interceptor元素之后会被创建成MappedInterceptor
...
public final class MappedInterceptor implements HandlerInterceptor {
    ...
    private final String[] includePatterns;         // 拦截的路径

    private final String[] excludePatterns;         // 不拦截的路径

    private final HandlerInterceptor interceptor;   // 被代理的 HandlerInterceptor
