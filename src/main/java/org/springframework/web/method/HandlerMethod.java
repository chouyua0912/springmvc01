...
public class HandlerMethod {
    ...
    private final Object bean;                  // 绑定用户提供的实现类
    ...
    private final Method bridgedMethod;         // 绑定的用户提供的Http请求处理方法反射实例

    private final MethodParameter[] parameters; // 被解析出来的方法入参

    private HttpStatus responseStatus;          // ResponseStatus注解的HttpStatus

    private String responseStatusReason;        // ResponseStatus注解的reason
